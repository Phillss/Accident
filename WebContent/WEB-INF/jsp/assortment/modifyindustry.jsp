...
<body>
	<div class="t">
		<div class="t3 main">
			...
			<div class="addin">
				<form
					action="${pageContext.request.contextPath}/assort/subindustry.action"
					method="post">
					<input type="hidden" name="in_id" value="${industry.in_id}">
					<div class="ch">
						<span>类别：</span> <span style="width: 138px;">行业</span> 
						<br /><br /> 
						<span>名称：</span> <input type="text" name="in_name" id="" value="${industry.in_name}" />
					</div>
					<div class="po">
